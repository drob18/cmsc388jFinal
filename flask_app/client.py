...
class Movie(object):
    def __init__(self, omdb_json, detailed=False):
        ...
        self.terpScores = [5,5,5,5,5]
        self.normalScores = [5,5,5,5,5]
        self.terpMean = 5
        self.normalMean = 5
    ...
    def updateTerpScore(self, data):
        self.terpScores.append(data)
        
        self.terpMean = getRating(self.terpScores)
        
        

    def updateNormalpScore(self, data):
        self.normalScores.append(data)
        self.normalMean = getRating(self.normalScores)
